 ...
 */
public class RotateLoadingLayout extends RefreshFooterLayout {
    ...
    @Override
    protected void init() {
        View view = LayoutInflater.from(mContext).inflate(R.layout.layout_refresh_bottom, this, false);
        ...
        imageDrawable = mContext.getResources().getDrawable(R.drawable.ref_default_ptr_rotate);
    ...
    protected void onResetImpl() {
        ...
        mImage.setImageDrawable(getResources().getDrawable(R.drawable.ref_refresh_complete));
