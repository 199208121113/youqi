package com.lg.base.ui.waterfall;
...
import com.lg.base.ui.waterfall.internal.PLA_AbsListView;
import com.lg.base.ui.waterfall.internal.PLA_AbsListView.OnScrollListener;
import com.lg.base.utils.DateUtil;

import java.util.List;

public class PullToRefreshWaterfallView extends MultiColumnListView implements OnScrollListener {
	
	@SuppressWarnings("unused")
	private static final String TAG = PullToRefreshWaterfallView.class.getSimpleName();
	...
	public void onScrollStateChanged(PLA_AbsListView view, int scrollState) {
		...
		if (lastItemCount == this.getAdapter().getCount() && scrollState == SCROLL_STATE_IDLE){
			onBottomRefresh();
		}
	}
	...
	public void onScroll(PLA_AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
		...
		lastItemCount = firstVisibleItem + visibleItemCount;// - 1;
		if(mStateChangeListenerList != null && mStateChangeListenerList.size() > 0){
			for (IOnScrollListener listener : mStateChangeListenerList) {
