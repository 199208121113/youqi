...
public class LeftSliderLayout extends ViewGroup {
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b) {
		...
		if (mMainChild != null) {
			mMainChild.layout(l, t, l + mMainChild.getMeasuredWidth(), t + mMainChild.getMeasuredHeight());
		}
		...
		if (nCount > 1) {
			...
			leftChild.layout(l - nLeftChildWidth, t, l, t + leftChild.getMeasuredHeight());
		}
	}
