...
final class DecodeHandler extends Handler implements IdConstant {
  ...
  private void decode(byte[] data, int width, int height) {
    ...
    if (rawResult != null) {
      ...
      Message message = Message.obtain(activity.getHandler(), IdConstant.decode_succeeded, rawResult);
      ...
      Message message = Message.obtain(activity.getHandler(), IdConstant.decode_failed);
      message.sendToTarget();
    }
  }
